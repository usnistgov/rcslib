...
*       This file should be named PM_SPHERICAL.java
*/
...
/*
*       Class definition for PM_SPHERICAL
...
public class PM_SPHERICAL extends PmSpherical
{
  ...
  public PM_SPHERICAL(double starttheta, double startphi, double startr)
  {
    super(starttheta, startphi, startr);
  }
