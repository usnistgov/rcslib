...
public class PmQuaternion implements Cloneable {
     ...
     * bug
     */
    protected PmQuaternion(double starts, double startx, double starty, double startz) throws PmException {
        s = starts;
        x = startx;
        y = starty;
        z = startz;
     ...
     * bug
     */
    public static PmQuaternion newSXYZ(double starts, double startx, double starty, double startz) throws PmException {
        return new PmQuaternion(starts, startx, starty, startz);
    }
