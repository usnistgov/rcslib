...
TESTNAME="STCP_with_DISP"
NMLCFG_OPTIONS="-D B1OPTS=remotetype=stcp%%%disp"
NML_TEST_BLOCKING=no
NML_TEST_LOCAL=no

# get_queue_length() and get_space_available() not implemented for this platform.
NO_SINGLE_PROCESS_QUEUE_TEST=1;
...
export NO_SINGLE_PROCESS_QUEUE_TEST
