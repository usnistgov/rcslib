...
public class TEST_MESSAGE_BASE extends RCS_STAT_MSG_V2 implements Cloneable
{
	...
	/* Getters and Setters */
	public int gettest_message_base_var() {
		return (test_message_base_var);
	}
	public void settest_message_base_var(int _test_message_base_var)  {
		this.test_message_base_var=_test_message_base_var;
	}
