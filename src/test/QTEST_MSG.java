...
public class QTEST_MSG extends NMLmsg implements Cloneable
{
	...
	public int getpchanges_count() {
		return (pchanges_count);
	}
	public void setpchanges_count(int _pchanges_count)  {
		this.pchanges_count=_pchanges_count;
	}
	...
	public void setline(byte [] _line)  {
		this.line=_line;
	}
