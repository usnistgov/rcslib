...
#ifndef GDRS_IM_CLNT_HH
#define GDRS_IM_CLNT_HH

#include "cms.hh"		/* class CMS */

class GDRS_IM_CLNT_NONPORT_INTERNALS;

class GDRS_IM_CLNT:public CMS
{
public:
  GDRS_IM_CLNT (const char *bufline, 
	  const char *procline);
 
  virtual ~ GDRS_IM_CLNT ();
...
protected:
  ...
  class GDRS_IM_CLNT_NONPORT_INTERNALS *internals;
...
private:
  ...
  GDRS_IM_CLNT(const GDRS_IM_CLNT &);
  GDRS_IM_CLNT &operator=(const GDRS_IM_CLNT &);
