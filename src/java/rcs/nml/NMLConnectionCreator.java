 ...
 * Connections created this way need to call SetMessageDict(), SetBufferName(), and 
 * ReadNMLConfigurationFile()  before they will be connected and usable.
 * 
...
public class  NMLConnectionCreator implements NMLConnectionCreatorInterface
{
    ...
    {
	return new rcs.nml.NMLConnection();
    }
}
