...
/*
	...
	MODIFICATIONS:
	Sun Mar 06 10:46:51 EST 2005	Created.
...
#include "prim.hh"	// definition of PRIM_MODULE

// flag signifying main loop is to terminate
int prim_done = 0;

//signal handler for ^C
extern "C" void prim_quit(int sig);
...
#endif
{
	...
	RCS_TIMER *timer = new RCS_TIMER(0.05);
	PRIM_MODULE *prim = new PRIM_MODULE();

	// set the SIGINT handler
	signal(SIGINT, prim_quit);
