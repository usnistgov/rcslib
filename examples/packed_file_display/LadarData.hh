...
#define LADAR_DATA_TYPE LADAR_DATA_BASE
#define LADAR_DATA_NAME "ladardata"

#define LADAR_SIZE_MAX 256*256		//!< LADAR_SIZE_MAX is the maximum number of pixels that a ladar may contain
...
#define LADAR_DATA_REV "$Rev: 670 $"
#define LADAR_DATA_ID "$Id: LadarData.hh 670 2009-02-18 18:51:15Z shackle $"

static const char *LADAR_DATA_HEADER_FILE=__FILE__;
